...
# ╠═╡ show_logs = false
using DifferentialEquations, PlutoUI, Plots; plotly()

# ╔═╡ 094873a1-3fa7-40b3-8143-57a5cbd8318f
md"""
 # Project 2: Feral Cat Control
#### Group: Euclid
#### Members: Rachel Ng, Benjamin Khor, Eddison Vasquez Fuentez

### Problem description:
Under the request SIMIODE, we have assumed the responsibility for the project concerning the large feral cat colony in Mr.Tom Kat's town. We will be demonstrating 2 commonly used methods for controlling feral population through graphical models, along with a model prediction of what would happen to the feral colony's population if no control method was implemented.
...
md"""
### Case 1: No Population Control
In this case, we will demonstrate what the feral cat population would be like in the scenario that Mr. Kat does not implement any population control on the feral cat colony
"""
...
md"""
### Case 3: Trap-Neuter
In this casde, a trap-neuter method will be implemented. For every trap set out, each captured feral cat will be neutered/spayed, then returned to their colony. This is the better form of population control. 
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "a6458b3e01b2c46f9ecdce3abd5345e2c9775eba"
...
git-tree-sha1 = "2bb3d6435c14df886de3247b3729d32e44aa7b88"
...
git-tree-sha1 = "aee667c9b44680f92ef021c50496b4309717e391"
